...
let reviews = [
  ...
  { id: 2, movieId: 1, userId: 1, text: "Definitely best animated movie ever." },
  { id: 3, movieId: 1, userId: 3, text: "Fr Fr no cap. Sigma movie. W rizz." },
  { id: 4, movieId: 2, userId: 1, text: "Classic sci-fi." }
];
